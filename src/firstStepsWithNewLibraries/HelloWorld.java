package firstStepsWithNewLibraries;
...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// doneTODO: Add code here that creates map2 
		// Then you'll modify draw() below
		map2 = new UnfoldingMap(this, 450, 50, 350, 500, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(51.1f, 17.0f));
	...
	public void draw() {
		...
		// doneTODO: Add code so that both maps are displayed
		map1.draw();
